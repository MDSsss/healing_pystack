...
def cadastro_medico(request):
    ...
    if is_medico(request.user):
        ...
        return redirect('/medicos/abrir_horario') # vai dar erro ainda, resolva na próxima aula
    ...
    if request.method == 'GET':
       ...
       return redirect('/medicos/abrir_horario') # vai dar erro ainda, fazer na próxima aula
...
# Desenvolver a dashboard do desenvolvimento médico